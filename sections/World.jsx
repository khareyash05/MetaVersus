  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    > 
      ...
      >
        ...
        <div className='absolute bottom-20 right-20 w-[70ox] h-[70px] rounded-full p-[6px] bg-[#5d6680] '>
        ...
        <div className='absolute top-1/2 left-[45%] w-[70ox] h-[70px] rounded-full p-[6px] bg-[#5d6680] '>
